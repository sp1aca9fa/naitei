...
export function InterviewPrepIndexPage() {
  ...
  // Group by interview round, sorted ascending
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-1">Prep guides for your active interviews.</p>
      </div>
      ...
      {loading ? (
        ...
        <p className="text-sm text-gray-400">No applications in the Interview stage yet.</p>
      ) : (
        <div className="space-y-8">
          {rounds.map(round => (
            <div key={round}>
              <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Round {round}</h3>
